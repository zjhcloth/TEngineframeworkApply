...
public class ResourcesArea
{
    ...
    [Tooltip("内网地址")] [SerializeField] private string m_InnerResourceSourceUrl = "http://127.0.0.1/CDN";

    public string InnerResourceSourceUrl => m_InnerResourceSourceUrl;

    [Tooltip("外网地址")] [SerializeField] private string m_ExtraResourceSourceUrl = "http://127.0.0.2/CDN";

    public string ExtraResourceSourceUrl => m_ExtraResourceSourceUrl;

    [Tooltip("正式地址")] [SerializeField] private string m_FormalResourceSourceUrl = "http://127.0.0.3/CDN";
...
public class FrameworkGlobalSettings
{
    ...
    public string FallbackHostServerURL = "http://127.0.0.1";
    ...
    [SerializeField] private List<ScriptGenerateRuler> scriptGenerateRule = new List<ScriptGenerateRuler>()
    {
        ...
        new ScriptGenerateRuler("m_tog", "Toggle"),
